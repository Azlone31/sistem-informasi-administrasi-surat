...
<body>
	...
	<ul class="nav">
			...
			<li>
				<a href="#subPages3" data-toggle="collapse" class=""><i class="glyphicon glyphicon-list-alt"></i> <span>Laporan</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
...
$det=mysqlI_query($conn, "select * from surat_masuk where id_surat='$id_srt'");
...
?>					
	<form action="#" method="post">
		<table class="table">
			<tr>
				<td>ID</td>
				<td><input type="text" class="form-control" name="id" value="<?php echo $d['id_surat'] ?>" id="disableInput" disabled></td>
			</tr>
			<tr>
				<td>Nomor Surat</td>
			...
			<tr>
				<td>Asal Surat</td>
				<td><input type="text" class="form-control" name="jenis_surat" value="<?php echo $d['asal_surat'] ?>" id="disableInput" disabled></td>
			</tr>
			<tr>
				<td>Tanggal Diterima</td>
				<td><input type="date" class="form-control" name="tanggal_dikeluarkan" value="<?php echo $d['tanggal_terima'] ?>" id="disableInput" disabled></td>
			</tr>
			<tr>
				<td>Perihal Surat</td>
				<td><input type="text" class="form-control" name="tujuan_surat" value="<?php echo $d['perihal_surat'] ?>" id="disableInput" disabled></td>
			</tr>
			<tr>
				<td>Tujuan Surat</td>
				<td><input type="text" class="form-control" name="ringkasan_surat" value="<?php echo $d['tujuan_surat'] ?>" id="disableInput" disabled></td>
			</tr>
				<!-- <td></td>

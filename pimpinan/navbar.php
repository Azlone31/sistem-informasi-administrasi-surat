<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.php"><img src="../assets/ico/rri.png" width="40px" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
 ...
 -->
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../assets/img/user2.png" class="img-circle" alt="Avatar"> <span>Pimpinan</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<ul class="dropdown-menu">
